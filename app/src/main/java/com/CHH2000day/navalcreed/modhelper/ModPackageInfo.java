...
public class ModPackageInfo {
    ...
    //软件版本
    public static final int PKGVER = Versions.VER_6;
    ...
    public static class Factory {
        ...
        public static ModPackageInfo createFromByteArray(byte[] data) throws ModPackageInfo.IllegalModInfoException {
            ...
            try {
                ...
                mpi.setModName(jo.getString(KEY_MODNANE));
                mpi.setModType(jo.getString(KEY_MODTYPE));
                mpi.setModAuthor(jo.getString(KEY_MODAUTHOR));
                mpi.setModInfo(jo.getString(KEY_MODINFO));
                mpi.setModTargetVer(jo.getInt(KEY_TARGETVER));
                if (jo.has(KEY_VERSION)) {
                    mpi.setVersion(jo.getInt(KEY_VERSION));
                }
                //检查是否有预览图并解码
                String b64pic = jo.getString(KEY_PREVIEW);
                ...
                if (jo.getBoolean(KEY_HASPREVIEW) && b64pic != null && b64pic.length() >= 60) {
                    byte[] piccache = android.util.Base64.decode(jo.getString(KEY_PREVIEW), android.util.Base64.DEFAULT);
    ...
    public static final class Versions {
        ...
        //ver6:include mod ver in conf file
